...
for cell in range(1, count):
    if (type(inputWorksheet.cell_value(cell,11)) == str):
        break
    if (inputWorksheet.cell_value(cell, 12) - inputWorksheet.cell_value(cell, 11) >= -2):
...
ws = wb["Sheet1"]
wsCell1 = ws.cell(10,1)
wsCell1.value = "1/2 Goal (+2.5 Away) (472)"
wsCell2= ws.cell(10,2)
